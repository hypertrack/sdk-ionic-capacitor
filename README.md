...
| **getLatestLocation**                 | (callback: <a href="#callback">Callback</a>) =&gt; void                                                                                                                                                                                               | Resolves latest device location that was sent by the SDK. Only available for Android platform.                        |
